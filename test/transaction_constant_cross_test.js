...
describe("Test Cross Shard Transaction", async function () {
    ...
    it("Should Be Able To Transfer Constant BACK From SHARD 1 to SHARD 0", async function () {
        ...
        const FeeResult2 = await shard1.EstimateFee("112t8roj4ZNc3mjUiAGoCwsrueBRiwYqE1URbUrJpBReRDZ5CDubBDUZtfN3Hxht3KtCFVNie1vsdWTPpTe3ydKHnnCvface41feiEahxJgd", {
        ...
        assert.equal(acc2BalanceNew, acc2Balance - 500 - fee * (FeeResult2.Response.Result.EstimateTxSizeInKb))
    })
