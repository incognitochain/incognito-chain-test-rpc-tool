...
!(async function () {
    ...
    // const res = await node1.CreateAndSendTransaction("112t8rqGc71CqjrDCuReGkphJ4uWHJmiaV7rVczqNhc33pzChmJRvikZNc3Dt5V7quhdzjWW9Z4BrB2BxdK5VtHzsG9JZdZ5M7yYYGidKKZV",{"1Uv2bWvMhSh3SVBsRvcjaoS17sCbQZRnTjP5cRMas94RNRdmUYXEJY1h93Vn4Z4ekSU3um57dLvpBSV7amFSs7NqqzUKuPqRYgjYbSmP8":1},100,0,64) || {};
    const sendTxResult = await shard.CreateAndSendStakingTransaction("112t8rqnMrtPkJ4YWzXfG82pd9vCe2jvWGxqwniPM5y4hnimki6LcVNfXxN911ViJS8arTozjH4rTpfaGo5i1KKcG1ayjiMsa4E3nABGAqQh",{"1Uv2bWvMhSh3SVBsRvcjaoS17sCbQZRnTjP5cRMas94RNRdmUYXEJY1h93Vn4Z4ekSU3um57dLvpBSV7amFSs7NqqzUKuPqRYgjYbSmP8":1},100,0,64) || {};
    ...
    let {BlockHash="", InputCoinPubKey=""} = txResult;
    ...
    while (true) {
        ...
        let {BestShardHeight = {}} = bestBeaconState;
    ...
    let {CandidateBeaconWaitingForNextRandom = []} = bestBeacon;
    ...
    while (true) {
        ...
        let {BestShardHeight = {}} = bestBeaconShardState;
        const shard0Height = BestShardHeight["0"];
